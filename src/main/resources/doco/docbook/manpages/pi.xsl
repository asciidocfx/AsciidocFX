...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <doc:reference xmlns="">
        <info>
            <title>manpages Processing Instruction Reference</title>
    ...
    <doc:pi name="dbman_funcsynopsis-style" xmlns="">
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbman funcsynopsis-style="kr"|"ansi"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
        ...
        <refsee role="params">
            <para>
                <parameter>man.funcsynopsis.style</parameter>
            </para>
        </refsee>
    </doc:pi>
