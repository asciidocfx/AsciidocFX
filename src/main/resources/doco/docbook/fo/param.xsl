...
<xsl:stylesheet exclude-result-prefixes="d"
    ...
    <xsl:attribute-set name="component.title.properties">
        ...
        <xsl:attribute name="text-align">
            <xsl:choose>
                <xsl:when
                        test="((parent::d:article | parent::d:articleinfo | parent::d:info/parent::d:article) and not(ancestor::d:book) and not(self::d:bibliography))         or (parent::d:slides | parent::d:slidesinfo)">
                    center
                </xsl:when>
