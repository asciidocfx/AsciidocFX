...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:key name="l10n-template-style" match="l:l10n/l:context/l:template[@style]"
             use="concat(../@name, '#', @name, '#', @style)"/>
            ...
            <xsl:for-each select="document(key('l10n-lang', $lang)/@href)">
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        ...
                        <xsl:for-each
                                select="$l10n.xml">  <!-- We need to switch context in order to make key() work -->
