...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <doc:template name="apply-character-map" xmlns="">
        ...
        <refdescription id="apply-character-map-desc">
            <para>This template applies an<link
                ...
                <parameter>map.contents</parameter>
            ...
            <note>
                <para>This template is a very slightly modified version of
                    Jeni Tennison’s
                    <function>replace_strings</function>
                    template in the
                    <link
                            xlink:href="http://www.dpawson.co.uk/xsl/sect2/StringReplace.html#d9351e13"
                            >multiple string replacements
                    </link>
                    section of Dave Pawson’s
                    <link xlink:href="http://www.dpawson.co.uk/xsl/index.html"
                            >XSLT FAQ</link>.
                </para>
                <para>The
                    <function>apply-string-subst-map</function>
                    template is essentially the same template as the
                    <function>apply-character-map</function>
                    template; the
                    only difference is that in the map that
                    <function>apply-string-subst-map</function>
                    expects,
                    <tag
                            class="attribute">oldstring
                    </tag>
                    and
                    <tag
                            class="attribute">newstring
                    </tag>
                    attributes are used
                    instead of
                    <tag class="attribute">character</tag>
                    and
                    <tag
    ...
    <doc:template name="read-character-map" xmlns="">
        ...
        <refdescription id="read-character-map-desc">
            <para>The XSLT 2.0 specification describes
                <link
                        xlink:href="http://www.w3.org/TR/xslt20/#character-maps"
                        >character maps
                </link>
                and explains how they may be used
                ...
                <function>read-character-map</function>
                template provides a
            ...
            <para>This template reads the character-map contents from
                ...
                the value of the
                <parameter>use.subset</parameter>
