...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
                ...
                xmlns:set="http://exslt.org/sets" xmlns:h="urn:x-hex" xmlns:ng="http://docbook.org/docbook-ng"
                xmlns:db="http://docbook.org/ns/docbook" xmlns:exslt="http://exslt.org/common" exslt:dummy="dummy"
                ng:dummy="dummy" db:dummy="dummy" extension-element-prefixes="exslt" version="1.0"
                exclude-result-prefixes="doc exsl set h db ng exslt d">
...
[FILES]
        ...
        <xsl:if test="$htmlhelp.enumerate.images">
            ...
            <xsl:choose>
                <xsl:when
                        test="$exsl.node.set.available != 0                     and function-available('set:distinct')">
    ...
    <xsl:template match="d:book" mode="hhc">
        ...
        <xsl:if test="d:part|d:reference|d:preface|d:chapter|d:appendix|d:bibliography|d:article|d:colophon|d:glossary">
            ...
            <UL>
                ...
                <xsl:apply-templates
                        select="d:part|d:reference|d:preface|d:chapter|d:bibliography|d:appendix|d:article|d:colophon|d:glossary"
                        mode="hhc"/>
            </UL><xsl:text>
</xsl:text>
        </xsl:if>
