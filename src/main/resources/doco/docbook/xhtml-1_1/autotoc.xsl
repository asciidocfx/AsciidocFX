...
<xsl:stylesheet exclude-result-prefixes="d"
    ...
    <xsl:template name="division.toc">
        ...
        <xsl:call-template name="make.toc">
            ...
            <xsl:with-param name="nodes"
                            select="d:part|d:reference                                          |d:preface|d:chapter|d:appendix                                          |d:article                                          |d:topic                                          |d:bibliography|d:glossary|d:index                                          |d:refentry                                          |d:bridgehead[$bridgehead.in.toc != 0]"/>
    ...
    <xsl:template name="component.toc">
        ...
        <xsl:call-template name="make.toc">
            ...
            <xsl:with-param name="toc.title.p" select="$toc.title.p"/>
            <xsl:with-param name="nodes"
                            select="d:section|d:sect1                                          |d:simplesect[$simplesect.in.toc != 0]                                          |d:topic                                          |d:refentry                                          |d:article|d:bibliography|d:glossary                                          |d:appendix|d:index                                          |d:bridgehead[not(@renderas)                                                      and $bridgehead.in.toc != 0]                                          |.//d:bridgehead[@renderas='sect1'                                                         and $bridgehead.in.toc != 0]"/>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template name="section.toc">
        ...
        <xsl:call-template name="make.toc">
            ...
            <xsl:with-param name="toc.title.p" select="$toc.title.p"/>
            <xsl:with-param name="nodes"
                            select="d:section|d:sect1|d:sect2|d:sect3|d:sect4|d:sect5|d:refentry                            |d:bridgehead[$bridgehead.in.toc != 0]"/>
    ...
    <xsl:template match="d:part|d:reference" mode="toc">
        ...
        <xsl:call-template name="subtoc">
            <xsl:with-param name="toc-context" select="$toc-context"/>
            <xsl:with-param name="nodes"
                            select="d:appendix|d:chapter|d:article|d:topic                                          |d:index|d:glossary|d:bibliography                                          |d:preface|d:reference|d:refentry                                          |d:bridgehead[$bridgehead.in.toc != 0]"/>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="d:preface|d:chapter|d:appendix|d:article|d:topic" mode="toc">
        ...
        <xsl:call-template name="subtoc">
            <xsl:with-param name="toc-context" select="$toc-context"/>
            <xsl:with-param name="nodes"
                            select="d:section|d:sect1                                          |d:simplesect[$simplesect.in.toc != 0]                                          |d:topic                                          |d:refentry                                          |d:glossary|d:bibliography|d:index                                          |d:bridgehead[$bridgehead.in.toc != 0]"/>
        </xsl:call-template>
    </xsl:template>
    ...
    <xsl:template match="d:section" mode="toc">
        ...
        <xsl:call-template name="subtoc">
            <xsl:with-param name="toc-context" select="$toc-context"/>
            <xsl:with-param name="nodes"
                            select="d:section|d:refentry                                          |d:simplesect[$simplesect.in.toc != 0]                                          |d:bridgehead[$bridgehead.in.toc != 0]"/>
        </xsl:call-template>
    </xsl:template>
