<?xml version="1.0" encoding="ASCII"?><!--This file was created automatically by html2xhtml--><!--from the HTML stylesheets.--><!-- This file is generated from param.xweb -->
<xsl:stylesheet exclude-result-prefixes="d"
    ...
    <xsl:param name="admon.style">
        <xsl:value-of
                select="concat('margin-', $direction.align.start,            ': 0.5in; margin-', $direction.align.end, ': 0.5in;')"/>
    </xsl:param>
    ...
    <xsl:attribute-set name="shade.verbatim.style">
        ...
        <xsl:attribute name="style"><xsl:text>background-color: </xsl:text>#E0E0E0
        </xsl:attribute>
    </xsl:attribute-set>
