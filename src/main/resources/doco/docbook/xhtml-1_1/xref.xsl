...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
                ...
                xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="suwl exsl xlink d" version="1.0">
        ...
        <xsl:choose>
            <xsl:when test="string(.) = ''">
                ...
                <xsl:variable name="entry"
                              select="$bib/d:bibliography/                                     *[@id=$id or @xml:id=$id][1]"/>
                <xsl:choose>
                    <xsl:when test="$entry">
                        <xsl:choose>
                            <xsl:when test="$bibliography.numbered != 0">
                                <xsl:number from="d:bibliography" count="d:biblioentry|d:bibliomixed" level="any"
                                            format="1"/>
                            </xsl:when>
    ...
    <xsl:template match="d:para|d:phrase|d:simpara|d:anchor|d:quote" mode="xref-to">
        ...
        <xsl:variable name="context"
                      select="(ancestor::d:simplesect                                        |ancestor::d:section                                        |ancestor::d:sect1                                        |ancestor::d:sect2                                        |ancestor::d:sect3                                        |ancestor::d:sect4                                        |ancestor::d:sect5                                        |ancestor::d:topic                                        |ancestor::d:refsection                                        |ancestor::d:refsect1                                        |ancestor::d:refsect2                                        |ancestor::d:refsect3                                        |ancestor::d:chapter                                        |ancestor::d:appendix                                        |ancestor::d:preface                                        |ancestor::d:partintro                                        |ancestor::d:dedication                                        |ancestor::d:acknowledgements                                        |ancestor::d:colophon                                        |ancestor::d:bibliography                                        |ancestor::d:index                                        |ancestor::d:glossary                                        |ancestor::d:glossentry                                        |ancestor::d:listitem                                        |ancestor::d:varlistentry)[last()]"/>
