...
(function ($opal) {
    ...
    return (function ($base) {
        ...
        (function ($base, $super) {
            function $OreillyConverter() {
            };
            var self = $OreillyConverter = $klass($base, $super, 'OreillyConverter', $OreillyConverter);
            ...
            return (def.$convert = function (node, template_name, opts) {
                    ...
                    var map = templateMap["oreilly"];

                    if (!map)
                        return "";

                    if (!map[obj.name]) {
                        var template = afx.getTemplate(obj.name + ".jade", "oreilly");
