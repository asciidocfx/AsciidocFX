        ...
        (function($base, $super) {
            ...
            def.$document = function(node) {
                ...
                if ((($a = node['$attr?']("toc")) !== nil && (!$a._isBoolean || $a == true))) {
                    result['$<<']("<?asciidoc-toc?>")};
                if ((($a = node['$attr?']("numbered")) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            def.$image = function(node) {
                var $a, self = this, width_attribute = nil, depth_attribute = nil, swidth_attribute = nil, scale_attribute = nil, align_attribute = nil;
            ...
            def.$listing = function(node) {
                ...
                if ((($a = (($b = node.$style()['$==']("source")) ? (node['$attr?']("language")) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
                    ...
                    listing_content = "<programlisting" + ((function() {if (informal !== false && informal !== nil) {
                        ...
                        return nil
                    }; return nil; })()) + " language=\"" + (node.$attr("language")) + "\" linenumbering=\"" + (numbering) + "\">" + (node.$content()) + "</programlisting>";
                } else {
            ...
            def.$math = function(node) {
                var $a, self = this, equation = nil, equation_data = nil;
            ...
            def.$olist = function(node) {
                var $a, $b, TMP_6, self = this, result = nil, num_attribute = nil;
            ...
            def.$table = function(node) {
                var $a, $b, TMP_7, $c, TMP_8, $d, TMP_9, $e, $f, TMP_14, self = this, result = nil, pgwide_attribute = nil, tag_name = nil, width = nil;
            ...
            def.$inline_anchor = function(node) {
                ...
                }}else if ("link"['$===']($case)) {return "<link xlink:href=\"" + (node.$target()) + "\">" + (node.$text()) + "</link>"}else if ("bibref"['$===']($case)) {return "<anchor" + (self.$common_attributes(self.$target(), nil, "[" + (node.$target()) + "]")) + "/>[" + (node.$target()) + "]"}else {return self.$warn("asciidoctor: WARNING: unknown anchor type: " + (node.$type().$inspect()))}})();
            };
            ...
            $opal.cdecl($scope, 'QUOTED_TAGS', $hash2(["emphasis", "strong", "monospaced", "superscript", "subscript", "double", "single"], {"emphasis": ["<emphasis>", "</emphasis>"], "strong": ["<emphasis role=\"strong\">", "</emphasis>"], "monospaced": ["<literal>", "</literal>"], "superscript": ["<superscript>", "</superscript>"], "subscript": ["<subscript>", "</subscript>"], "double": ["&#8220;", "&#8221;"], "single": ["&#8216;", "&#8217;"]}));

            $scope.QUOTED_TAGS['$default=']([nil, nil]);

            def.$inline_quoted = function(node) {
                var $a, self = this, type = nil, open = nil, close = nil, text = nil, quoted_text = nil, role = nil;
                ...
                if (((type = node.$type()))['$==']("latexmath")) {
                    ...
                    $a = $opal.to_ary($scope.QUOTED_TAGS['$[]'](type)), open = ($a[0] == null ? nil : $a[0]), close = ($a[1] == null ? nil : $a[1]);
                    text = node.$text();
                    quoted_text = (function() {if ((($a = (role = node.$role())) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            def.$document_info_element = function(doc, info_tag_prefix, use_info_tag_prefix) {
                ...
                if ((($a = doc.$notitle()) !== nil && (!$a._isBoolean || $a == true))) {
                    ...
                    result['$<<'](((function() {if ((($a = doc['$header?']()) !== nil && (!$a._isBoolean || $a == true))) {
                        return (self.$document_title_tags(doc.$header().$title()))
                    } else {
                        return "<title>" + (doc.$attr("untitled-label")) + "</title>"
                    }; return nil; })()))
                };
            ...
            def.$document_title_tags = function(title) {
                var $a, self = this, _ = nil, subtitle = nil;

                if ((($a = title['$include?'](": ")) !== nil && (!$a._isBoolean || $a == true))) {
                    $a = $opal.to_ary(title.$rpartition(": ")), title = ($a[0] == null ? nil : $a[0]), _ = ($a[1] == null ? nil : $a[1]), subtitle = ($a[2] == null ? nil : $a[2]);
...
(function($opal) {
    ...
    return (function($base) {
        ...
        (function($base, $super) {
            ...
            def.$document_info_element = TMP_1 = function(doc, info_tag_prefix) {
                var self = this, $iter = TMP_1._p, $yield = $iter || nil;

                TMP_1._p = null;
                return $opal.find_super_dispatcher(self, 'document_info_element', TMP_1, null).apply(self, [doc, info_tag_prefix, true]);
            };

            return (def.$document_ns_attributes = function(doc) {
                var $a, self = this;

                if ((($a = (doc['$attr?']("noxmlns"))) !== nil && (!$a._isBoolean || $a == true))) {
                    return nil
                } else {
