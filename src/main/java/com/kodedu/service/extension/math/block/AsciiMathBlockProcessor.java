...
@Component
@Scope("prototype")
public class AsciiMathBlockProcessor extends MathBlockProcessor {

    public AsciiMathBlockProcessor(Environment environment, MathJaxService mathJaxService, ThreadService threadService, MathProcessor mathProcessor) {
