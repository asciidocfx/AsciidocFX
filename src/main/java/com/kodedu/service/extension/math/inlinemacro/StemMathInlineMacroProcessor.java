...
@Name("stem_") // _ replaced in preprocesser
@Format(FormatType.SHORT)
@ContentModel(ContentModel.RAW)
@Component
@Scope("prototype")
public class StemMathInlineMacroProcessor extends MathInlineMacroProcessor {
    public StemMathInlineMacroProcessor(Environment environment, MathJaxService mathJaxService, ThreadService threadService, MathProcessor mathProcessor) {
