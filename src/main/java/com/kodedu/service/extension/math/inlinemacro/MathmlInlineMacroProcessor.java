...
@Name("mathml_") // _ replaced in preprocesser
@Format(FormatType.SHORT)
@ContentModel(ContentModel.RAW)
@Component
@Scope("prototype")
public class MathmlInlineMacroProcessor extends MathInlineMacroProcessor {
    public MathmlInlineMacroProcessor(Environment environment, MathJaxService mathJaxService, ThreadService threadService, MathProcessor mathProcessor) {
