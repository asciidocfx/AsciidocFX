...
@Component
@Scope("prototype")
public class TexMathBlockProcessor extends MathBlockProcessor {

    public TexMathBlockProcessor(Environment environment, MathJaxService mathJaxService, ThreadService threadService, MathProcessor mathProcessor) {
