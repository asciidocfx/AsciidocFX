...
@Name("latexmath_") // _ replaced in preprocesser
@Format(FormatType.SHORT)
@ContentModel(ContentModel.RAW)
@Component
@Scope("prototype")
public class LatexMathInlineMacroProcessor extends MathInlineMacroProcessor {
    public LatexMathInlineMacroProcessor(Environment environment, MathJaxService mathJaxService, ThreadService threadService, MathProcessor mathProcessor) {
