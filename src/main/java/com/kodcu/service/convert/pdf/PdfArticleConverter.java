 ...
 */
@Component
public class PdfArticleConverter extends AbstractPdfConverter {

    private final Logger logger = LoggerFactory.getLogger(PdfArticleConverter.class);
    ...
    @Autowired
    public PdfArticleConverter(final ApplicationController asciiDocController, final DocBookConverter docBookConverter,
