 ...
 */
@Component
public class DocArticleConverter implements DocbookTraversable, DocumentConverter<String> {
    ...
    @Autowired
    public DocArticleConverter(final Current current, ThreadService threadService, MarkdownService markdownService, ApplicationController controller, HtmlPane htmlPane) {
    ...
    public void convert(boolean askPath, Consumer<String>... nextStep) {
        ...
        markdownService.convert(text, asciidoc -> {
            threadService.runActionLater(() -> {
                ...
                String rendered = htmlPane.convertDocbookArticle(asciidoc);
