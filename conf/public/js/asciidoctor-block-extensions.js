...
function registerBlockExtensions(name) {
    ...
    Opal.modules[name + "-block/extension"] = function (Opal) {
        ...
        var __self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice,
            $klass = Opal.klass, $hash2 = Opal.hash2;
    ...
    Opal.modules[name + "-block"] = function (Opal) {
        Opal.dynamic_require_severity = "ignore";
        var $a, $b, TMP_1, __self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker,
            $slice = Opal.slice;
