...
<xsl:stylesheet exclude-result-prefixes="d"
    ...
    <xsl:template name="component.subtitle">
        ...
        <xsl:variable name="subtitle"
                      select="($node/d:docinfo/d:subtitle                         |$node/d:info/d:subtitle                         |$node/d:prefaceinfo/d:subtitle                         |$node/d:chapterinfo/d:subtitle                         |$node/d:appendixinfo/d:subtitle                         |$node/d:articleinfo/d:subtitle                         |$node/d:artheader/d:subtitle                         |$node/d:subtitle)[1]"/>
    ...
    <xsl:template match="d:acknowledgements/d:title|d:acknowledgements/d:info/d:title" mode="titlepage.mode"
                  priority="2">
        <xsl:call-template name="component.title">
    ...
    <xsl:template match="d:acknowledgements/d:subtitle|d:acknowledgements/d:info/d:subtitle" mode="titlepage.mode"
                  priority="2">
        <xsl:call-template name="component.subtitle">
            <xsl:with-param name="node" select="ancestor::d:acknowledgements[1]"/>
        </xsl:call-template>
    ...
    <xsl:template match="d:topic/d:subtitle                      |d:topic/d:info/d:subtitle" mode="titlepage.mode"
                  priority="2">
        <xsl:call-template name="component.subtitle">
            <xsl:with-param name="node" select="ancestor::d:topic[1]"/>
        </xsl:call-template>
