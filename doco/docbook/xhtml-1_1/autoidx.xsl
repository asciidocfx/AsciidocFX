...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
                ...
                extension-element-prefixes="exslt" exclude-result-prefixes="exslt d" version="1.0">
    ...
    <xsl:key name="letter" match="d:indexterm"
    ...
    <xsl:key name="primary" match="d:indexterm"
             use="normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary))"/>

    <xsl:key name="secondary" match="d:indexterm"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)))"/>

    <xsl:key name="tertiary" match="d:indexterm"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)))"/>

    <xsl:key name="endofrange" match="d:indexterm[@class='endofrange']" use="@startref"/>

    <xsl:key name="primary-section" match="d:indexterm[not(d:secondary) and not(d:see)]"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, generate-id((ancestor-or-self::d:set|ancestor-or-self::d:book|ancestor-or-self::d:part|ancestor-or-self::d:reference|ancestor-or-self::d:partintro|ancestor-or-self::d:chapter|ancestor-or-self::d:appendix|ancestor-or-self::d:preface|ancestor-or-self::d:article|ancestor-or-self::d:section|ancestor-or-self::d:sect1|ancestor-or-self::d:sect2|ancestor-or-self::d:sect3|ancestor-or-self::d:sect4|ancestor-or-self::d:sect5|ancestor-or-self::d:refentry|ancestor-or-self::d:refsect1|ancestor-or-self::d:refsect2|ancestor-or-self::d:refsect3|ancestor-or-self::d:simplesect|ancestor-or-self::d:bibliography|ancestor-or-self::d:glossary|ancestor-or-self::d:index|ancestor-or-self::d:webpage|ancestor-or-self::d:topic)[last()]))"/>

    <xsl:key name="secondary-section" match="d:indexterm[not(d:tertiary) and not(d:see)]"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, generate-id((ancestor-or-self::d:set|ancestor-or-self::d:book|ancestor-or-self::d:part|ancestor-or-self::d:reference|ancestor-or-self::d:partintro|ancestor-or-self::d:chapter|ancestor-or-self::d:appendix|ancestor-or-self::d:preface|ancestor-or-self::d:article|ancestor-or-self::d:section|ancestor-or-self::d:sect1|ancestor-or-self::d:sect2|ancestor-or-self::d:sect3|ancestor-or-self::d:sect4|ancestor-or-self::d:sect5|ancestor-or-self::d:refentry|ancestor-or-self::d:refsect1|ancestor-or-self::d:refsect2|ancestor-or-self::d:refsect3|ancestor-or-self::d:simplesect|ancestor-or-self::d:bibliography|ancestor-or-self::d:glossary|ancestor-or-self::d:index|ancestor-or-self::d:webpage|ancestor-or-self::d:topic)[last()]))"/>

    <xsl:key name="tertiary-section" match="d:indexterm[not(d:see)]"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)), &#34; &#34;, generate-id((ancestor-or-self::d:set|ancestor-or-self::d:book|ancestor-or-self::d:part|ancestor-or-self::d:reference|ancestor-or-self::d:partintro|ancestor-or-self::d:chapter|ancestor-or-self::d:appendix|ancestor-or-self::d:preface|ancestor-or-self::d:article|ancestor-or-self::d:section|ancestor-or-self::d:sect1|ancestor-or-self::d:sect2|ancestor-or-self::d:sect3|ancestor-or-self::d:sect4|ancestor-or-self::d:sect5|ancestor-or-self::d:refentry|ancestor-or-self::d:refsect1|ancestor-or-self::d:refsect2|ancestor-or-self::d:refsect3|ancestor-or-self::d:simplesect|ancestor-or-self::d:bibliography|ancestor-or-self::d:glossary|ancestor-or-self::d:index|ancestor-or-self::d:webpage|ancestor-or-self::d:topic)[last()]))"/>

    <xsl:key name="see-also" match="d:indexterm[d:seealso]"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)), &#34; &#34;, d:seealso)"/>

    <xsl:key name="see" match="d:indexterm[d:see]"
             use="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)), &#34; &#34;, d:see)"/>
    ...
    <xsl:template name="generate-basic-index">
        ...
        <div class="index">
            <xsl:if test="$others">
                <xsl:choose>
                    <xsl:when
                            test="normalize-space($type) != '' and                          $others[@type = $type][count(.|key('primary', normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1]) = 1]">
                        <div class="indexdiv">
                            <h3>
                            ...
                            <dl>
                                <xsl:apply-templates
                                        select="$others[count(.|key('primary', normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1]) = 1]"
    ...
    <xsl:template match="d:indexterm" mode="index-symbol-div">
        ...
        <xsl:apply-templates
                select="key('letter', $key)                                [count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][count(.|key('primary', normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)))[1]) = 1]"
                mode="index-primary">
            <xsl:with-param name="position" select="position()"/>
            <xsl:with-param name="scope" select="$scope"/>
            <xsl:with-param name="role" select="$role"/>
    ...
    <xsl:template match="d:indexterm" mode="index-primary">
        ...
        <dt>
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:for-each
                            select="$refs[not(d:see)                                and not(d:secondary)][count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))]">
                        <xsl:apply-templates select="." mode="reference">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
            ...
            <xsl:if test="$refs[not(d:secondary)]/*[self::d:see]">
                <xsl:apply-templates
                        select="$refs[generate-id() = generate-id(key('see', concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, &#34; &#34;, &#34; &#34;, d:see))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1])]"
                        mode="index-see">
                    <xsl:with-param name="position" select="position()"/>
                    <xsl:with-param name="scope" select="$scope"/>
                    <xsl:with-param name="role" select="$role"/>
        ...
        <xsl:choose>
            <xsl:when test="$refs/d:secondary or $refs[not(d:secondary)]/*[self::d:seealso]">
                <dd>
                    <dl>
                        <xsl:apply-templates
                                select="$refs[generate-id() = generate-id(key('see-also', concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, &#34; &#34;, &#34; &#34;, d:seealso))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1])]"
                                mode="index-seealso">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
                        ...
                        <xsl:apply-templates
                                select="$refs[d:secondary and count(.|key('secondary', concat($key, &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary))))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1]) = 1]"
    ...
    <xsl:template match="d:indexterm" mode="index-secondary">
        ...
        <xsl:variable name="key"
                      select="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)))"/>
        <xsl:variable name="refs"
        ...
        <dt>
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:for-each
                            select="$refs[not(d:see)                                  and not(d:tertiary)][count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))]">
                        <xsl:apply-templates select="." mode="reference">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
            ...
            <xsl:if test="$refs[not(d:tertiary)]/*[self::d:see]">
                <xsl:apply-templates
                        select="$refs[generate-id() = generate-id(key('see', concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, &#34; &#34;, d:see))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1])]"
                        mode="index-see">
                    <xsl:with-param name="position" select="position()"/>
                    <xsl:with-param name="scope" select="$scope"/>
                    <xsl:with-param name="role" select="$role"/>
        ...
        <xsl:choose>
            <xsl:when test="$refs/d:tertiary or $refs[not(d:tertiary)]/*[self::d:seealso]">
                <dd>
                    <dl>
                        <xsl:apply-templates
                                select="$refs[generate-id() = generate-id(key('see-also', concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, &#34; &#34;, d:seealso))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1])]"
                                mode="index-seealso">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
                        ...
                        <xsl:apply-templates
                                select="$refs[d:tertiary and count(.|key('tertiary', concat($key, &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary))))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1]) = 1]"
                                mode="index-tertiary">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
    ...
    <xsl:template match="d:indexterm" mode="index-tertiary">
        ...
        <xsl:variable name="key"
                      select="concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)))"/>
        <xsl:variable name="refs"
        ...
        <dt>
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:for-each
                            select="$refs[not(d:see)][count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))]">
                        <xsl:apply-templates select="." mode="reference">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
            ...
            <xsl:if test="$refs/d:see">
                <xsl:apply-templates
                        select="$refs[generate-id() = generate-id(key('see', concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)), &#34; &#34;, d:see))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1])]"
                        mode="index-see">
                    <xsl:with-param name="position" select="position()"/>
                    <xsl:with-param name="scope" select="$scope"/>
                    <xsl:with-param name="role" select="$role"/>
        ...
        <xsl:choose>
            <xsl:when test="$refs/d:seealso">
                <dd>
                    <dl>
                        <xsl:apply-templates
                                select="$refs[generate-id() = generate-id(key('see-also', concat(normalize-space(concat(d:primary/@sortas, &#34; &#34;, d:primary)), &#34; &#34;, normalize-space(concat(d:secondary/@sortas, &#34; &#34;, d:secondary)), &#34; &#34;, normalize-space(concat(d:tertiary/@sortas, &#34; &#34;, d:tertiary)), &#34; &#34;, d:seealso))[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1])]"
                                mode="index-seealso">
                            <xsl:with-param name="position" select="position()"/>
                            <xsl:with-param name="scope" select="$scope"/>
                            <xsl:with-param name="role" select="$role"/>
                    ...
                    <xsl:variable name="title">
                        <xsl:choose>
                            <xsl:when test="$index.prefer.titleabbrev != 0">
                                <xsl:apply-templates
                                        select="(ancestor-or-self::d:set|ancestor-or-self::d:book|ancestor-or-self::d:part|ancestor-or-self::d:reference|ancestor-or-self::d:partintro|ancestor-or-self::d:chapter|ancestor-or-self::d:appendix|ancestor-or-self::d:preface|ancestor-or-self::d:article|ancestor-or-self::d:section|ancestor-or-self::d:sect1|ancestor-or-self::d:sect2|ancestor-or-self::d:sect3|ancestor-or-self::d:sect4|ancestor-or-self::d:sect5|ancestor-or-self::d:refentry|ancestor-or-self::d:refsect1|ancestor-or-self::d:refsect2|ancestor-or-self::d:refsect3|ancestor-or-self::d:simplesect|ancestor-or-self::d:bibliography|ancestor-or-self::d:glossary|ancestor-or-self::d:index|ancestor-or-self::d:webpage|ancestor-or-self::d:topic)[last()]"
                            ...
                            <xsl:when test="$index.links.to.section = 1">
                                <xsl:call-template name="href.target">
                                    ...
                                    <xsl:with-param name="context"
                                                    select="(//d:index[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))] | //d:setindex[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))])[1]"/>
                                </xsl:call-template>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:call-template name="href.target">
                ...
                <a>
                    ...
                    <xsl:attribute name="href">
                        <xsl:call-template name="href.target">
                            ...
                            <xsl:with-param name="context"
                                            select="//d:index[count(ancestor::node()|$scope) = count(ancestor::node()) and ($role = @role or $type = @type or (string-length($role) = 0 and string-length($type) = 0))][1]"/>
                        </xsl:call-template>
                    </xsl:attribute>
