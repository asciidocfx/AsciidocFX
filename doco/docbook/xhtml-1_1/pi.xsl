...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
                ...
                xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="doc d" version="1.0">
    ...
    <doc:pi xmlns="" name="dbhtml_background-color">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="BGcolor.html">Background color</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_bgcolor">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="BGtableColor.html#CellBGColor">Cell background color</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_cellpadding">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para><link role="tcg" xlink:href="CellSpacing.html">Cell spacing and cell padding</link>,
                <link role="tcg" xlink:href="QandAformat.html">Q and A formatting</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_class">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="CSSTableCells.html">Table styles in HTML output</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_dir">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="Chunking.html#dbhtmlDirPI">dbhtml dir processing instruction</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_filename">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="Chunking.html#DbhtmlFilenames">dbhtml filenames</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_img.src.path">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="GraphicsLocations.html#UsingFileref">Using fileref</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_linenumbering.everyNth">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="AnnotateListing.html#LineNumbering">Line numbering</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_list-presentation">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="Variablelists.html#VarListFormatting">Variable list formatting in HTML
                </link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_row-height">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="RowHeight.html">Row height</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_start">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="Orderedlists.html#ListStartNum">List starting number</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_stop-chunking">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="Chunking.html">Chunking into multiple HTML files</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_table-summary">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para><link role="tcg" xlink:href="Variablelists.html#VarListFormatting">Variable list formatting in
                HTML</link>,
                <link role="tcg" xlink:href="TableSummary.html">Table summary text</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml_table-width">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="Tables.html#TableWidth">Table width</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhtml-include_href">
        <refpurpose xmlns="http://www.w3.org/1999/xhtml">Copies an external well-formed HTML/XML file into current doc
        </refpurpose>
        <refdescription xmlns="http://www.w3.org/1999/xhtml">
            <para>Use the
                <tag class="xmlpi">dbhtml-include href</tag>
                PI anywhere in a
        ...
        <refsynopsisdiv xmlns="http://www.w3.org/1999/xhtml">
            <synopsis>
                <tag class="xmlpi">dbhtml-include href="<replaceable>URI</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter xmlns="http://www.w3.org/1999/xhtml">
            <variablelist>
                <varlistentry>
                    <term>href="<replaceable>URI</replaceable>"
                    </term>
                    <listitem>
                        <para>Specifies the URI for the file to include; the URI
                            can be, for example, a remote
                            <literal>http:</literal>
                            URI, or a local filesystem
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="params">
            <para>
                <parameter>textinsert.extension</parameter>
            </para>
        </refsee>
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para><link role="tcg" xlink:href="InsertExtHtml.html">Inserting external HTML code</link>,
                <link role="tcg" xlink:href="ExternalCode.html">External code files</link>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi xmlns="" name="dbhh">
        ...
        <refsee xmlns="http://www.w3.org/1999/xhtml" role="tcg">
            <para>
                <link role="tcg" xlink:href="HtmlHelp.html#HHContextHelp">Context-sensitive help</link>
            </para>
        </refsee>
    </doc:pi>
