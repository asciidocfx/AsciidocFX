...
<xsl:stylesheet exclude-result-prefixes="d"
    ...
    <xsl:template match="d:primaryie">
        ...
        <dd>
            <xsl:apply-templates
                    select="following-sibling::d:seeie                                    [not(preceding-sibling::d:secondaryie)]"
                    mode="indexentry"/>
            <xsl:apply-templates
                    select="following-sibling::d:seealsoie                                    [not(preceding-sibling::d:secondaryie)]"
                    mode="indexentry"/>
        ...
        <dl>
            ...
            <dd>
                ...
                <xsl:variable name="see.intersection"
                              select="$after.this[count(.|$before.entry) = count($before.entry)]                                 [self::d:seeie or self::d:seealsoie]"/>
                <xsl:choose>
                ...
                <xsl:variable name="tertiary.intersection"
                              select="$after.this[count(.|$before.next.secondary) =                                   count($before.next.secondary)]                                 [not(self::d:seeie) and not(self::d:seealsoie)]"/>
                <xsl:choose>
