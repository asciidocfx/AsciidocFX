...
<xsl:stylesheet
    ...
    <doc:pi name="dbfo_background-color" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo background-color</tag>
                PI before or
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo background-color="<replaceable>color</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_bgcolor" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo bgcolor</tag>
                PI as child of a table row
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo bgcolor="<replaceable>color</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_float-type" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo float-type</tag>
                PI to specify the float
                behavior for a
                <tag>sidebar</tag>
                (to cause the sidebar to be
                displayed as a marginal note).
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo float-type="margin.note"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>float-type="margin.note"</term>
                    <listitem>
        ...
        <refsee role="params">
            <para>
                <parameter>sidebar.float.type</parameter>
                (parameter),
                <parameter>sidebar.float.width</parameter>
                (parameter),
                <parameter>sidebar.properties</parameter>
                (attribute-set),
        ...
        <refsee role="tcg">
            <para>
                <link role="tcg" xlink:href="SideFloats.html#SidebarFloats">A sidebar as
                    side float
                </link>
            </para>
        </refsee>
    ...
    <doc:pi name="dbfo_funcsynopsis-style" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo funcsynopsis-style</tag>
                PI as a child of
                a
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo funcsynopsis-style="kr"|"ansi"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
    ...
    <doc:pi name="dbfo_glossary-presentation" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo glossary-presentation</tag>
                PI as a child of
                a
                <tag>glossary</tag>
                to control its presentation style.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo glossary-presentation="list"|"blocks"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>glossary-presentation="list"</term>
                    <listitem>
                        <para>Displays the glossary as a list</para>
                    </listitem>
                </varlistentry>
                <varlistentry>
                    <term>glossary-presentation="blocks"</term>
                    <listitem>
        ...
        <refsee role="tcg">
            <para>
                <link role="tcg" xlink:href="Glossaries.html#GlossaryFormatPrint">Glossary
                    formatting in print
                </link>
            </para>
        </refsee>
    ...
    <doc:pi name="dbfo_glosslist-presentation" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo glosslist-presentation</tag>
                PI as a child of
                a
                <tag>glosslist</tag>
                to control its presentation style.
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo glosslist-presentation="list"|"blocks"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>glosslist-presentation="list"</term>
                    <listitem>
                        <para>Displays the glosslist as a list</para>
                    </listitem>
                </varlistentry>
                <varlistentry>
                    <term>glosslist-presentation="blocks"</term>
                    <listitem>
    ...
    <doc:pi name="dbfo_glossterm-width" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo glossterm-width</tag>
                PI as a child of a
                <tag>glossary</tag>
                or
                <tag>glosslist</tag>
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo glossterm-width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>glossterm-width="<replaceable>width</replaceable>"
                    </term>
                    <listitem>
    ...
    <doc:pi name="dbfo_keep-together" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo keep-together</tag>
                PI as a child of a
            ...
            <para>The PI also works with<tag>informaltable</tag>,<tag>informalexample</tag>,
                ...
                and<tag>informalequation</tag>.
            </para>

        </refdescription>
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo keep-together="auto"|"always"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>keep-together="auto"</term>
                    <listitem>
                        <para>Enables the object to break across a page</para>
                    </listitem>
                </varlistentry>
                <varlistentry>
                    <term>keep-together="always"</term>
                    <listitem>
        ...
        <refsee role="tcg">
            <para>
                <link role="tcg" xlink:href="PageBreaking.html#KeepTogetherPI"
    ...
    <doc:pi name="dbfo_label-width" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo label-width</tag>
                PI as a child of a
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo label-width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_linenumbering.everyNth" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo linenumbering.everyNth</tag>
                PI as a child
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo linenumbering.everyNth="<replaceable>N</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_linenumbering.separator" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo linenumbering.separator</tag>
                PI as a child
                of a “verbatim” element –<tag>programlisting</tag>,
                <tag>screen</tag>,
                <tag>synopsis</tag>
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo linenumbering.separator="<replaceable>text</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_linenumbering.width" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo linenumbering.width</tag>
                PI as a child
                of a “verbatim” element –<tag>programlisting</tag>,
                <tag>screen</tag>,
                <tag>synopsis</tag>
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo linenumbering.width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_list-presentation" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo list-presentation</tag>
                PI as a child of
                a
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo list-presentation="list"|"blocks"|"table"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                ...
                <varlistentry>
                    <term>list-presentation="blocks"</term>
                    <listitem>
                        <para>(
                            <tag>variablelist</tag>
                            only) Displays the list as blocks
                        </para>
                    </listitem>
                </varlistentry>
                <varlistentry>
                    ...
                    <listitem>
                        <para>(
                            <tag>segmentedlist</tag>
                            only) Displays the list as a table
                        </para>
                    </listitem>
                </varlistentry>
            </variablelist>
        ...
        <refsee role="params">
            <itemizedlist>
                <listitem>
                    <para>
                        <parameter>variablelist.as.blocks</parameter>
                    </para>
                </listitem>
                <listitem>
                    <para>
    ...
    <doc:pi name="dbfo_list-width" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo list-width</tag>
                PI as a child of a
                <tag>simplelist</tag>
                whose
                <tag class="attribute">class</tag>
                value is<literal>horizontal</literal>, to specify the width
                of the<tag>simplelist</tag>.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo list-width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_orientation" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo orientation</tag>
                PI as a child of a CALS
                <tag>table</tag>
                row or cell to specify the orientation
                (rotation) for the row or cell.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo orientation="0"|"90"|"180"|"270"|"-90"|"-180"|"-270"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>orientation="0"|"90"|"180"|"270"|"-90"|"-180"|"-270"</term>
                    <listitem>
    ...
    <doc:pi name="dbfo_pgwide" xmlns="">
        <refpurpose>Specifies if an
            <tag>equation</tag>
            or
            <tag>example</tag>
            goes across full page width
        </refpurpose>
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo pgwide</tag>
                PI as a child of an
                <tag>equation</tag>
                or
                <tag>example</tag>
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo pgwide="0"|"1"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
        ...
        <refsee role="params">
            <para>
                <parameter>pgwide.properties</parameter>
            </para>
        </refsee>
    </doc:pi>
    ...
    <doc:pi name="dbfo_rotated-width" xmlns="">
        <refpurpose>Specifies the width for a CALS table
            <tag>entry</tag>
            or
            <tag>row</tag>
        </refpurpose>
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo rotated-width</tag>
                PI as a child of
                <tag>entry</tag>
                or
                <tag>row</tag>
                instance in a CALS table to specify the
                width of that the
                <tag>entry</tag>
                or<tag>row</tag>; or
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo rotated-width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>rotated-width="<replaceable>width</replaceable>"
                    </term>
                    <listitem>
    ...
    <doc:pi name="dbfo_sidebar-width" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo sidebar-width</tag>
                PI as a child of a
                <tag>sidebar</tag>
                to specify the width of the sidebar.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo sidebar-width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>sidebar-width="<replaceable>width</replaceable>"
                    </term>
                    <listitem>
                        <para>Specifies the
                            <tag>sidebar</tag>
    ...
    <doc:pi name="dbfo_start" xmlns="">
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo start="<replaceable>character</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_term-width" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo term-width</tag>
                PI as a child of a
                <tag>variablelist</tag>
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo term-width="<replaceable>width</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
    ...
    <doc:pi name="dbfo_toc" xmlns="">
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo toc="0"|"1"</tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
    ...
    <doc:pi name="dbfo-need" xmlns="">
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo-need height="<replaceable>n</replaceable>" [space-before="<replaceable>
                    n</replaceable>"]
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
            <variablelist>
                <varlistentry>
                    <term>height="<replaceable>n</replaceable>"
                    </term>
                    <listitem>
                ...
                <varlistentry>
                    <term>space-before="<replaceable>n</replaceable>"
                    </term>
                    <listitem>
    ...
    <doc:pi name="dbfo_row-height" xmlns="">
        ...
        <refdescription>
            <para>Use the
                <tag class="xmlpi">dbfo row-height</tag>
                PI as a child of a
                <tag>row</tag>
        ...
        <refsynopsisdiv>
            <synopsis>
                <tag class="xmlpi">dbfo row-height="<replaceable>height</replaceable>"
                </tag>
            </synopsis>
        </refsynopsisdiv>
        <refparameter>
