...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="ns">
        ...
        <xsl:choose>
            ...
            <xsl:when test="//*[namespace-uri() = 'http://www.w3.org/1999/xhtml']">http://www.w3.org/1999/xhtml
            </xsl:when>
        </xsl:choose>
    </xsl:param>
    ...
    <doc:template match="t:templates" xmlns="" id="templates">
        ...
        <refdescription>
            <para>The
                <literal>t:templates</literal>
                element is the root of a
                set of templates. This template creates an appropriate
                <literal>xsl:stylesheet</literal>
                for the templates.
            </para>
            ...
            <para>If the
                <literal>t:templates</literal>
                element has a
                <literal>base-stylesheet</literal>
                attribute, an
    ...
    <doc:template match="t:titlepage" xmlns="" id="titlepage">
        ...
        <refdescription>
            <para>The
                ...
                <quote>
                    <literal>wrapper.titlepage</literal>
                </quote>
                . That is the
            ...
            <para>The
                ...
                <variablelist>
                    <varlistentry>
                        ...
                        <listitem>
                            <para>The name of the source document element for which
                                ...
                                element, set the
                                <sgmltag class="attribute">element</sgmltag>
                                attribute to
                                <quote>
                    ...
                    <varlistentry>
                        ...
                        <listitem>
                            <para>If the
                                <sgmltag class="attribute">class</sgmltag>
                                attribute
                                is set, a
                                <sgmltag class="attribute">class</sgmltag>
                                attribute with this
            ...
            <para>The content of a
                <literal>t:titlepage</literal>
                is one or
                more<literal>t:titlepage-content</literal>,
                <literal>t:titlepage-separator</literal>, and
                <literal>t:titlepage-before</literal>
                elements.
            </para>

            <para>Each of these elements may be provided for the
                <quote>recto</quote>
                and
                <quote>verso</quote>
            ...
            <xsl:element name="{@t:wrapper}" namespace="{$ns}">
                ...
                <xsl:element name="xsl:variable">
                    ...
                    <xsl:element name="xsl:choose">
                        ...
                        <xsl:text>&#xA;        </xsl:text>
                        <xsl:element name="xsl:when">
                            <xsl:attribute name="test">contains(system-property('xsl:vendor'), 'Apache Software
                                Foundation')
                            </xsl:attribute>
                            <xsl:text>&#xA;          </xsl:text>
                ...
                <xsl:element name="xsl:if">
                    <xsl:attribute name="test">(normalize-space($recto.content) != '') or ($recto.elements.count > 0)
                    </xsl:attribute>
                    <xsl:text>&#xA;      </xsl:text>
                    <xsl:element name="{@t:wrapper}" namespace="{$ns}">
                ...
                <xsl:text>&#xA;    </xsl:text>
                <xsl:element name="xsl:if">
                    <xsl:attribute name="test">(normalize-space($verso.content) != '') or ($verso.elements.count > 0)
                    </xsl:attribute>
                    <xsl:text>&#xA;      </xsl:text>
                    <xsl:element name="{@t:wrapper}" namespace="{$ns}">
    ...
    <doc:template match="@*" mode="copy.literal.atts" xmlns=""
        ...
        <refdescription>
            <para>This template copies all of the
                <quote>other</quote>
                attributes
                from a
                <literal>t:titlepage</literal>
                element onto the specified
                wrapper.
            </para>
        </refdescription>
    </doc:template>
    ...
    <doc:template match="t:titlepage-content" id="titlepage-content">
        ...
        <refdescription>
            ...
            <para>The
                <literal>t:titlepage-content</literal>
                    ...
                    <varlistentry>
                        ...
                        <listitem>
                            <para>Identifies the side of the page to which this title
                                ...
                                <sgmltag class="attribute">side</sgmltag>
                                attribute is required and
                                must be set to either
                                <quote>
                                    <literal>recto</literal>
                                </quote>
                                or
                                <quote>
                                    <literal>verso</literal>
                                </quote>
                                . In addition, you must specify
                                exactly one
                                <literal>t:titlepage-content</literal>
                                for each side
                                within each<literal>t:titlepage</literal>.
                            </para>
                        </listitem>
                    </varlistentry>
                    <varlistentry>
                        ...
                        <listitem>
                            <para>Indicates how the order of the elements presented on
                                ...
                                <sgmltag class="attribute">order</sgmltag>
                                is
                                <quote>
  ...
  <t:titlepage-contents side="recto">
    ...
    <!-- other titlepage elements -->
            ...
            <para>In that case, you can put a
                <literal>t:or</literal>
                group inside
                the
                <literal>authorgroup</literal>
                element:
    ...
    <doc:template match="t:titlepage-separator" id="titlepage-separator">
        ...
        <refdescription>
            <para>The title page is separated from the content which follows it by
                the markup specified in the
                <literal>t:titlepage-separator</literal>
                element.
            </para>
        </refdescription>
    </doc:template>
    ...
    <doc:template match="*" mode="titlepage.specialrules" xmlns=""
        ...
        <refdescription>
            <para>This template is called to process all of the descendants of the
                <literal>t:titlepage-content</literal>
                element that require special
                processing. At present, that's just
                <literal>t:or</literal>
                elements.
            </para>
        </refdescription>
