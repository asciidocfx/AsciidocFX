...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <doc:template name="get.refentry.metadata" xmlns="">
        ...
        <refdescription id="get.refentry.metadata-desc">
            <para>Reference documentation for particular commands, functions,
                ...
                embed "context" information in output for each<tag>refentry</tag>.
            </para>
            ...
            <para>Taking all that in mind, the
                <function>get.refentry.metadata</function>
                template tries to gather
                metadata from a
                <tag>refentry</tag>
        ...
        <refparameter id="get.refentry.metadata-params">
            <variablelist>
                ...
                <varlistentry>
                    <term>info</term>
                    <listitem>
                        <para>A set of info nodes (from a
                            <tag>refentry</tag>
        ...
        <refreturn id="get.refentry.metadata-returns">
            <para>Returns a node set with the following elements. The
                descriptions are verbatim from the
                <literal>man(7)</literal>
                man
                page.
                <variablelist>
                    <varlistentry>
                        <term>title</term>
                        <listitem>
                            <para>the title of the man page (e.g.,<literal>MAN</literal>)
                            </para>
                        </listitem>
                    </varlistentry>
                    <varlistentry>
    ...
    <doc:template name="get.refentry.section" xmlns="">
        ...
        <refdescription id="get.refentry.section-desc">
            <para>The
                ...
                <literal>7</literal>)". If we do not find a
                <tag>manvolnum</tag>
                specified in the source, and we find that the
                <tag>refentry</tag>
                is
                for a function, we use the section number
                <literal>3</literal>
    ...
    <doc:template name="get.refentry.source.name" xmlns="">
        ...
        <refdescription id="get.refentry.source.name-desc">
            <para>A "source name" is one part of a (potentially) two-part
                ...
                <function>get.refentry.source</function>
                template.
            </para>
        </refdescription>
        ...
        <refdescription id="get.refentry.manual-desc">
            <para>The
                ...
                <itemizedlist>
                    <listitem>
                        <para>
                            <citetitle>dpkg utilities</citetitle>
                            (<command>dpkg-name</command>)
                        </para>
                    </listitem>
                    <listitem>
                        <para>
                            <citetitle>User Contributed Perl Documentation</citetitle>
                            (<command>GET</command>)
                        </para>
                    </listitem>
                    <listitem>
                        <para>
                            <citetitle>GNU Development Tools</citetitle>
                            (<command>ld</command>)
                        </para>
                    </listitem>
                    <listitem>
                        <para>
                            <citetitle>Emperor Norton Utilities</citetitle>
                            (<command>ddate</command>)
                        </para>
                    </listitem>
                    <listitem>
                        <para>
                            <citetitle>Debian GNU/Linux manual</citetitle>
                            (<command>faked</command>)
                        </para>
                    </listitem>
                    <listitem>
                        <para>
                            <citetitle>GIMP Manual Pages</citetitle>
                            (<command>gimp</command>)
                        </para>
                    </listitem>
                    <listitem>
                        <para>
                            <citetitle>KDOC Documentation System</citetitle>
                            (<command>qt2kdoc</command>)
                        </para>
                    </listitem>
                </itemizedlist>
            </para>
            ...
            <para>The
                ...
                <blockquote>
                    <para>This is the section title of the reference page; for
                        example<literal>User Commands</literal>.
                    </para>
                </blockquote>
            </para>
    ...
    <doc:template name="get.refentry.metadata.prefs" xmlns="">
        ...
        <refdescription id="get.refentry.metadata.prefs-desc">
            <para>The DocBook XSL stylesheets include several user-configurable
                ...
                <function>get.refentry.metadata.prefs</function>
                template,
    ...
    <doc:template name="set.refentry.metadata" xmlns="">
        ...
        <refdescription id="set.refentry.metadata-desc">
            <para>The
                <function>set.refentry.metadata</function>
                template is
